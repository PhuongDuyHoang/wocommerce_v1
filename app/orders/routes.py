...
from app import db
from app.models import WooCommerceOrder, WooCommerceStore, AppUser, Setting
...
def manage_all_orders():
    ...
    # Tối ưu truy vấn: sử dụng options để tải trước dữ liệu liên quan, tránh N+1 query
    ...
    if current_user.is_super_admin():
        pass # Super admin có quyền xem tất cả
    ...
    for order in orders:
        ...
        # Gán thuộc tính 'products' để tương thích với cấu hình cột
