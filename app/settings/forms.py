...
class UserSettingsForm(FlaskForm):
    ...
    """
    telegram_bot_token = StringField('Telegram Bot Token (Cá nhân)', validators=[Optional(), Length(max=255)])
    telegram_chat_id = StringField('Telegram Chat ID (Cá nhân)', validators=[Optional(), Length(max=255)])
